      ...
      >
        ...
        <DialogContent>
          ...
          <DialogContent dividers>
            ...
            <Typography>
              Having a correlation of 1 would mean we're perfectly estimating
              the time every time. This is obviously the ideal we all want to
              find ourselves in.
            </Typography>
            <Typography>
              Unfortunately, reaching a 1 is impossible. It's inevitable that
              something will go wrong at some point. Anything below ~0.6,
              though, is a weak correlation and tells us we can't realistically
          ...
          <DialogContent dividers>
            ...
            <Typography>
              ...
              possibly be at estimating. It would effectively be no different
              than using random numbers for the estimates.
            </Typography>
            <Typography>
            ...
            <Typography>
              If this is where you find yourself, it may be best to no longer
              try to estimate, since it doesn't help establish useful timelines
              and may be causing other issues (e.g. adding stress, which leads
              to more mistakes). The time normally spent coming up with
              estimates could instead be put towards getting productive work
              done.
            </Typography>
          </DialogContent>
          {/* -1 */}
          <DialogContent dividers>
            ...
            <Typography>
              ...
              consistently taking longer than the tasks we believed would be
              much more time consuming. The scale is effectively backwards.
            </Typography>
            <Typography>
            ...
            <Typography>
              If you're in the negative range, it may be best to take a good
              look at what is happening where the work is actually being done.
              Are people taking less care because of the the pressumed ease or
