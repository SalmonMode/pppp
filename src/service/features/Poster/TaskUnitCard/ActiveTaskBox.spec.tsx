...
describe("React Integration: ActiveTaskBox", function (): void {
  describe("With Label, Extension, And Prereqs", function (): void {
    ...
    describe("Outer Box", function (): void {
      ...
      it("should have a width equal to the actual duration plus review box width", function (): void {
    ...
    describe("Label Wrapper", function (): void {
      ...
      it("should have flex basis equal to expected duration minus prereqs", function (): void {
        expect(Number(wrapperStyles.flexBasis.slice(0, -2))).to.equal(
          expectedDuration - theme.prerequisitesBoxWidth
        );
      });
    });
  ...
  describe("Without Label, More Time Than Anticipated, And No Prereqs", function (): void {
    let labelText: string;
    let boxStyles: CSSStyleDeclaration;
    let wrapperStyles: CSSStyleDeclaration;
    ...
    describe("Label Wrapper", function (): void {
      ...
      it("should have flex basis equal to expected duration", function (): void {
        expect(Number(wrapperStyles.flexBasis.slice(0, -2))).to.equal(
          expectedDuration
        );
      });
