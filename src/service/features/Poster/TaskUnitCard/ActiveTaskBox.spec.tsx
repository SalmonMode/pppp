...
describe("React Integration: ActiveTaskBox", function (): void {
  describe("Only Known Iteration With Label, Extension, And Prereqs", function (): void {
    ...
    describe("Outer Box", function (): void {
      ...
      it("should have a width equal to the actual duration plus review box width minus both borders width", function (): void {
  ...
  describe("First Known Iteration With Label, Extension, And Prereqs", function (): void {
    let labelText: string;
    let boxStyles: CSSStyleDeclaration;
    let wrapperStyles: CSSStyleDeclaration;
    let prereqIndex: number;
    ...
    describe("Outer Box", function (): void {
      ...
      it("should have a width equal to the actual duration plus review box width minus one border width", function (): void {
        expect(Number(boxStyles.width.slice(0, -2))).to.equal(
    ...
    describe("Label Wrapper", function (): void {
      ...
      it("should have flex basis equal to expected duration minus prereqs and one border width", function (): void {
        expect(Number(wrapperStyles.flexBasis.slice(0, -2))).to.equal(
  ...
  describe("Intermediate Iteration Without Label, More Time Than Anticipated, And No Prereqs", function (): void {
    ...
    describe("Outer Box", function (): void {
      ...
      it("should have a width equal to the actual duration plus review box width minus neither borders width", function (): void {
        expect(Number(boxStyles.width.slice(0, -2))).to.equal(
